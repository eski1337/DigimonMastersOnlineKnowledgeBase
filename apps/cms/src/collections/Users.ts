...
<body style="margin: 0; padding: 0; background-color: #0a0a0a; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
  ...
  fields: [
    ...
    // but we keep explicit config for indexing and auto-generation
    {
      ...
      index: true,
      admin: {
        description: { en: 'Unique username for login', zh: '用於登入的唯一使用者名稱' },
      },
      hooks: {
        beforeValidate: [
          ({ value, data }) => {
    ...
    },
    {
      ...
      defaultValue: 'member',
      options: [
        { label: { en: 'Guest', zh: '訪客' }, value: 'guest' },
        { label: { en: 'Member', zh: '成員' }, value: 'member' },
        { label: { en: 'Editor', zh: '編輯者' }, value: 'editor' },
        { label: { en: 'Admin', zh: '管理員' }, value: 'admin' },
        { label: { en: 'Owner', zh: '擁有者' }, value: 'owner' },
      ],
      access: {
        create: ({ req: { user } }) => {
    ...
    {
      type: 'collapsible',
      label: { en: 'Profile', zh: '個人檔案' },
      admin: { initCollapsed: true },
      fields: [
        {
          name: 'banner',
          label: { en: 'Profile Banner', zh: '個人檔案橫幅' },
          type: 'upload',
          relationTo: 'media',
          admin: { description: { en: 'Banner image for your profile page (recommended 1200×400)', zh: '個人檔案頁面的橫幅圖片（建議 1200×400）' } },
        },
        {
          name: 'bio',
          label: { en: 'Bio', zh: '自我介紹' },
          type: 'textarea',
          maxLength: 500,
          admin: { description: { en: 'Tell others about yourself (max 500 chars)', zh: '介紹一下自己（最多 500 字）' } },
        },
        {
          name: 'location',
          ...
          type: 'text',
          maxLength: 100,
          admin: { description: { en: 'Your location (optional)', zh: '你的所在地（選填）' } },
        },
        {
          name: 'socialLinks',
          label: { en: 'Social Links', zh: '社群連結' },
          type: 'group',
          admin: { description: { en: 'Your social media profiles', zh: '你的社群媒體帳號' } },
          fields: [
        ...
        },
        {
          ...
          label: { en: 'Profile Visibility', zh: '個人檔案可見度' },
          type: 'select',
          defaultValue: 'public',
          options: [
            { label: { en: 'Public', zh: '公開' }, value: 'public' },
            { label: { en: 'Registered Users Only', zh: '僅限註冊使用者' }, value: 'registered' },
            { label: { en: 'Private', zh: '私人' }, value: 'private' },
          ],
          admin: { description: { en: 'Who can see your profile', zh: '誰可以查看你的個人檔案' } },
        },
        {
          name: 'allowMessages',
          label: { en: 'Allow Direct Messages', zh: '允許私訊' },
          type: 'select',
          defaultValue: 'everyone',
          options: [
            { label: { en: 'Everyone', zh: '所有人' }, value: 'everyone' },
            { label: { en: 'Registered Users', zh: '註冊使用者' }, value: 'registered' },
            { label: { en: 'Nobody', zh: '無人' }, value: 'nobody' },
          ],
          admin: { description: { en: 'Who can send you direct messages', zh: '誰可以傳送私訊給你' } },
        },
        {
          name: 'allowProfileComments',
          label: { en: 'Allow Profile Comments', zh: '允許檔案留言' },
          type: 'select',
          defaultValue: 'everyone',
          options: [
            { label: { en: 'Everyone', zh: '所有人' }, value: 'everyone' },
          ...
          admin: { description: { en: 'Who can comment on your profile wall', zh: '誰可以在你的個人檔案留言' } },
        },
        {
          name: 'lastSeen',
          label: { en: 'Last Seen', zh: '最後上線' },
          type: 'date',
          admin: { readOnly: true, description: { en: 'Last activity timestamp', zh: '最後活動時間戳記' } },
        },
      ],
    },
  ],
