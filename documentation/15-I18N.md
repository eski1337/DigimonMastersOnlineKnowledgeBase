...
export default createMiddleware({
  locales: ['en', 'ja', 'ko', 'zh'],
  defaultLocale: 'en',
  localePrefix: 'as-needed', // /en/digimon → /digimon for default
});
...
```
en.dmokb.info/digimon/agumon
ja.dmokb.info/digimon/agumon
```

**Option 3: Domain**

```
dmokb.info/digimon/agumon (EN)
...
**Fallback**:
- If translation missing → show English version
...
```html
<link rel="alternate" hreflang="en" href="https://dmokb.info/digimon/agumon" />
<link rel="alternate" hreflang="ja" href="https://dmokb.info/ja/digimon/agumon" />
<link rel="alternate" hreflang="ko" href="https://dmokb.info/ko/digimon/agumon" />
<link rel="alternate" hreflang="zh" href="https://dmokb.info/zh/digimon/agumon" />
<link rel="alternate" hreflang="x-default" href="https://dmokb.info/digimon/agumon" />
```
...
- Before: 1 field × 1000 Digimon = 1000 fields
- After: 4 fields × 1000 Digimon = 4000 fields
...
test('switches language', async ({ page }) => {
  ...
  await expect(page.locator('h1')).toContainText('アグモン');
});
```
